...
`;function nt(){const[t,s]=y.useState(!1);return e.jsxs(ce.Ribbon,{text:e.jsx(S,{children:"Hippies"}),children:[e.jsxs(it,{vertical:!0,gap:16,children:[e.jsxs(d,{gap:16,children:[e.jsx(de,{shape:"square",size:64,icon:e.jsx(G,{})}),e.jsxs(d,{vertical:!0,gap:16,children:[e.jsx(S,{children:"@gladk0ff"}),e.jsx(S,{children:"sergladkov@outlook.com"}),e.jsx(S,{children:"Гладков Андрей"})]})]}),e.jsx(at,{icon:e.jsx(ue,{}),size:"large",type:"text",onClick:()=>s(!0)})]}),e.jsx(H,{open:t,closable:!1,footer:null,centered:!0,destroyOnClose:!0,title:"Реадктирование данных профиля",children:e.jsx(tt,{onCancel:()=>{s(!1)}})})]})}const it=u(d)`
	min-width: 400px;
	padding: 1rem;
`,at=u(m)`
	position: absolute;
...
`,St=100,vt=({active:t=!1,tasks:s=[],completedTasks:n=[]})=>{const[a,i]=y.useState(!1),r=Y();if(y.useEffect(()=>{!t&&a&&i(!1)},[t]),!r.typeId)return null;const o=k[r.typeId],{activeTasks:g=[],newTasks:w=[]}=s.reduce((h,T)=>(T.status_id==="new"&&h.newTasks.push(T),T.status_id==="active"&&h.activeTasks.push(T),h),{newTasks:[],activeTasks:[]}),j=g.filter(({done:h})=>h).length;return e.jsxs(At,{vertical:!0,align:"start",gap:8,children:[e.jsxs(Pt,{vertical:!0,style:{width:"100%"},children:[e.jsx($,{title:"В работе",complite:j,total:g.length,taskStatus:I.active,tasks:g}),e.jsx($,{title:"Запланированы",total:w.length,taskStatus:I.new,tasks:w})]}),e.jsxs(d,{justify:"space-between",style:{width:"100%"},children:[e.jsx(m,{type:"text",htmlType:"button",onClick:h=>{h.stopPropagation(),i(!0)},children:"Показать выполненные"}),o&&e.jsx(J,{content:e.jsx("div",{style:{width:500},children:o.info}),title:"Разяснение в помощь о текуших задач",children:e.jsx(m,{shape:"circle",icon:e.jsx(V,{}),size:"large",type:"text"})})]}),e.jsx(Re,{title:e.jsxs(S,{children:[" Звершенные задачи :",St]}),placement:"bottom",size:"large",onClose:h=>{h.stopPropagation(),i(!1)},open:a,getContainer:!1,children:e.jsx(d,{vertical:!0,gap:16,style:{padding:"0rem 1rem"},children:n.map((h,T)=>y.createElement(wt,{...h,key:T}))})})]})},At=u(d)`
	height: 100%;
	width: 100%;
...
`;let v=document.getElementById("root");v||(v=document.createElement("div"),v.id="root",document.body.appendChild(v));He(v).render(e.jsx(cs,{}));
